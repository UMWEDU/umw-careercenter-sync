...
Handshake is UMW’s official job and internship database. Handshake allows you the opportunity to create an employer profile, post part-time and full-time jobs, internships, and volunteer opportunities, view student and alumni resumes, post events, and message our students. It is free for both employers and students to use.
...
Hosting a virtual recruiting event will allow you to connect with students and alumni without having to come to campus. Events must be requested via Handshake.

For more information, and steps on requesting virtual events, <a href="https://www.umw.edu/careercenter/employers/virtual-recruiting-events/">click here.</a>

</div>
<div class="one-half">
<h2>Host Virtual Interviews</h2>
If your company is looking to conduct interviews virtually, this can be done via your <a href="https://umw.joinhandshake.com/">Handshake</a> account. You can request dates, set time frames, review and approve/deny applicants, and allow them to choose a time slot in your schedule.
